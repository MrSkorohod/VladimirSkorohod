...
cloth.appendChild(secondHand);
 setInterval(()=>{
     ...
     minuteHand.setAttribute("x2", `${Math.round(angleX(angleMinute)+ radius + 30)}`);
     minuteHand.setAttribute("y2", `${Math.round(angleY(angleMinute)+ radius) + 30}`);
     secondHand.setAttribute("x2", `${Math.round(angleX(angleSecond)+ radius + 30)}`);
     secondHand.setAttribute("y2", `${Math.round(angleY(angleSecond)+ radius + 30)}`);
 }, 1000);
